...
- **Context architecture**: Designing the specification layer between organisational intent and AI-executable action. In practice: mapping what an organisation knows, identifying where that knowledge is trapped in documents or silos, and building systems that let it move.
- **Strategic landscape analysis**: Using mapping and systems thinking to help clients see where their organisation sits, where the industry is heading, and what moves are available to them that competitors cannot yet see.
- **AI implementation strategy**: Working with organisations on how to deploy AI systems responsibly, specifying what persistent agents do autonomously, what they flag for human review, and what they never touch.
- **Research-to-strategy translation**: Converting academic research, qualitative insight, and market intelligence into decision frameworks that executives can actually act from.
...
- Developed brand positioning frameworks that differentiated the product in a competitive e-commerce landscape.
...
- Managed large cross-functional teams in campaign execution — creative, media, production, activation — delivering brand experiences that consistently exceeded client satisfaction benchmarks.
- Built long-term client partnerships through a consultative approach: translating business objectives into communication strategy and ensuring strategic coherence through execution.
...
The programme sits at the intersection of economics, systems thinking, innovation theory, and public purpose. It is not a standard business MSc. It is explicitly designed to question the assumptions underpinning conventional measures of economic success and to develop frameworks for thinking about prosperity at civilisational scale.

Dissertation: *Prosperity: A Multidimensional Qur'anic Perspective*
The thesis argues that GDP-led prosperity metrics are structurally incomplete — not broken, but designed for a narrow purpose. It draws on Islamic economic principles, Theory U (Scharmer), and multi-level perspective frameworks to propose a Universal Prosperity Model: a multidimensional approach integrating economic, social, spiritual, ecological, knowledge, and governance dimensions.

Grade: **Distinction**

Relevant modules: Digital Transformation (IIPP0011), Researching Transformative Entrepreneurship (BGLP0011), Strategic Project Management (MSIN0147), Urban Futures and Prosperity (BGLP0009), Transformative Entrepreneurship and Prosperity: Design and Core Concepts (BGLP0010/0012)
