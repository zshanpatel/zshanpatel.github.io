...
draft: false
---
## 🧢 The 3-layer content creation system 
This is an engineered system that multiplies one piece of writing across multiple platforms using AI prompts that deconstruct what works, swipe files that validate ideas before publishing, and a 3-layer methodology that turns research into building blocks instead of finished drafts.

This guide breaks down the workflow: how to build your swipe file, engineer custom prompts, and turn one newsletter into YouTube videos, daily posts, LinkedIn articles, and short-form video scripts without sacrificing your voice.
...
```
### Layer 3: Meta-Prompt
Give it to the [Prompt Generator](08-prompt-generator.md) meta-prompt. 
...
2. **Find 3–6 hours of YouTube content on the topic**  
   Paste URLs into [Gemini 2.5](https://gemini.google.com/):  
```
Summarise the key points from this video related to [your topic]
```
3. **Cross-reference past writing:**  
...
Paste newsletter with the [**Deep Post Ideas**](06-deep-post-ideas.md) prompt. 
...
- [**YouTube Title Generator**](07-youtube-title.md): 20–30 title variations using psychological triggers.
- [**Content Ideas / Creative Thought Partner**](05-creative-thought-partner.md): Harsh advice, counterintuitive truths, pain points, insights.
