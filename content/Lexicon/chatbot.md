...
title: Chatbot
name: chatbot
description: Software that holds a conversation with a user through text or voice, following scripted rules or, more recently, a language model — the oldest and most commercially proven form AI takes in a product.
aliases:
  - chatbots
  - intelligent chatbot
tags:
...
### 🔗 Related Concepts
- [[ai-agent|The More Autonomous Descendant of the Chatbot]]
- [[llm|The Technology Modern Chatbots Are Built On]]
