...
title: Agency Model
name: agency-model
description: A business structure where a firm is paid to act on a client's behalf — running campaigns, managing accounts, or in this essay's case, deploying and maintaining AI tools — rather than selling the client a product outright.
aliases:
...
human-reviewed: true
---
> The agency model does not sell the tools. It acts as the middle-man, selling whatever is in demand, running the tool, for as long as someone keeps paying.
