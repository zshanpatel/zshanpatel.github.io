...
description: The total market value of a company's or asset's outstanding shares — share price multiplied by shares outstanding — used as the standard, if imperfect, proxy for an asset's size and significance in a market.
aliases:
  - market cap
tags:
  - term
...
Reading a sector's market capitalisation chart without that caveat is exactly the reading that makes the number look more like invested value than it is — see [[Lexicon/memecoin|Memecoin]] for why that gap matters most acutely.
