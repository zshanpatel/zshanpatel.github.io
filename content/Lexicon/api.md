...
name: api
description: A defined interface that lets one piece of software interact with and use another's functionality without needing to know how it's built internally. It is the mechanism that lets an app "call" ChatGPT or Claude over the internet instead of running the model itself.
aliases:
