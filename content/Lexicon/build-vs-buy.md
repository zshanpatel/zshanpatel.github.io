...
title: Build vs. Buy
name: build-vs-buy
description: The decision of whether to develop a capability in-house or purchase it ready-made from an outside vendor — the central strategic question this essay's "evolving tech" thinking is actually asking.
aliases:
  - Build versus buy
  - Make or buy
tags:
...
This is the exact fork this essay is standing at. A "cut-paste solution" — a chatbot, a scheduler, a generic automation — is a commodity: buy it, or build it once and resell the same thing repeatedly. An "ecosystem" — a coordinated, business-specific combination of tools — is closer to the specialised end, where in-house judgment about how the pieces fit together is the actual product being sold. [[wardley-mapping|Wardley Mapping]] is the tool built specifically to visualise where any given component sits on that spectrum, so the build-or-buy call isn't a guess.
...
### 🔗 Related Concepts
- [[wardley-mapping|The Tool for Mapping This Decision]]
- [[saas|The 'Buy' Side of This Decision, Rented]]
- [[ecosystems|What You're Building Toward on the 'Build' Side]]
