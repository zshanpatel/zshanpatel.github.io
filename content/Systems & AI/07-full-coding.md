---
name: ai-expert-coding
description: A production-grade procedural methodology for working with AI coding assistants (IDE rules, MCP configuration, and unit testing).
type: workflow
series_order: 7
---
## Quick Overview (TLDR)
...
* **Use markdown files to manage the project** (`README.md`, `PLAN.md`, `TASKS.md`).
...
Before writing any code, it’s important to have a conversation with the LLM to plan the initial scope and tasks for the project. Scope goes into `PLAN.md`, and specific tasks go into `TASKS.md`. These should be updated by the AI coding assistant as the project progresses.
### `PLAN.md`
* Purpose: High-level vision, architecture, constraints, tech stack, tools, etc.  
* Prompt to AI: *“Use the structure and decisions outlined in PLAN.md.”*  
* Have the LLM reference this file at the beginning of any new conversation.
### `TASKS.md`
* Purpose: Tracks current tasks, backlog, and sub-tasks.  
* Includes: Bullet list of active work, milestones, and anything discovered mid-process.  
* Prompt to AI: *“Update `TASKS.md` to mark XYZ as done and add ABC as a new task.”*  
...
The first prompt to begin a project is the most important. Even with a comprehensive overview in `PLAN.md`, clear tasks in `TASKS.md`, and good global rules, it’s still important to give a lot of details to describe exactly what you want the LLM to create for you and documentation for it to reference.
...
After creating the MCP server with FastMCP, update README.md and TASKS.md since you now have the initial implementation for the server.
```
...
Remember to always have the LLM update `README.md,PLAN.md`, and `TASKS.md` after making any changes!
